        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="search-info">
                        Menampilkan hasil untuk: <strong><?php echo e($keyword); ?></strong>
                        <?php if (!empty($dramas) && is_array($dramas)): ?>
                            <span class="ml-2">(<span class="text-muted"><?php echo count($dramas); ?> drama ditemukan</span>)</span>
                        <?php endif; ?>
                    </p>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="empty-state">
                    ...
                    <p>Tidak ada drama yang cocok dengan pencarian "<?php echo e($keyword); ?>"</p>
                    <p class="mt-3">Coba kata kunci lain atau browse berdasarkan genre</p>
                    <a href="<?php echo url('search'); ?>" class="back-btn">
                        <i class="fas fa-arrow-left"></i> Cari Lagi
                    </a>
                    <br>
                    <a href="<?php echo url('genre'); ?>" class="back-btn" style="background-color: #6c757d; margin-left: 10px;">
                        <i class="fas fa-th-large"></i> Browse Genre
                    </a>
                </div>
            <?php endif; ?>
        </div>
